...
namespace stm32f217::registers::rcc {
...
struct RCC_CR {
  ...
  static constexpr cpp_register::Field<decltype(RCC->CR), (1UL << 26), cpp_register::AccessMode::RW, 1> PLLI2SON{};
...
struct RCC_PLLCFGR {
  static constexpr cpp_register::Field<decltype(RCC->PLLCFGR), (1UL << 24), cpp_register::AccessMode::RW, 4> PLLQ{};
  static constexpr cpp_register::Field<decltype(RCC->PLLCFGR), (1UL << 22), cpp_register::AccessMode::RW, 1> PLLSRC{};
  static constexpr cpp_register::Field<decltype(RCC->PLLCFGR), (1UL << 16), cpp_register::AccessMode::RW, 2> PLLP{};
  static constexpr cpp_register::Field<decltype(RCC->PLLCFGR), (1UL << 6), cpp_register::AccessMode::RW, 9> PLLN{};
  static constexpr cpp_register::Field<decltype(RCC->PLLCFGR), (1UL << 0), cpp_register::AccessMode::RW, 6> PLLM{};
};

struct RCC_CFGR {
  static constexpr cpp_register::Field<decltype(RCC->CFGR), (1UL << 10), cpp_register::AccessMode::RW, 3, 2> PPRE{};
...
struct RCC_AHB2RSTR {
  ...
  static constexpr cpp_register::Field<decltype(RCC->AHB2RSTR), (1UL << 5), cpp_register::AccessMode::RW, 1> HSAHRST{};
  static constexpr cpp_register::Field<decltype(RCC->AHB2RSTR), (1UL << 4), cpp_register::AccessMode::RW, 1> CRYPRST{};
...
struct RCC_AHB2ENR {
  ...
  static constexpr cpp_register::Field<decltype(RCC->AHB2ENR), (1UL << 5), cpp_register::AccessMode::RW, 1> HASHEN{};
  static constexpr cpp_register::Field<decltype(RCC->AHB2ENR), (1UL << 4), cpp_register::AccessMode::RW, 1> CRYPEN{};
...
struct RCC_AHB2LPENR {
  ...
  static constexpr cpp_register::Field<decltype(RCC->AHB2LPENR), (1UL << 5), cpp_register::AccessMode::RW, 1> HASHLPEN{};
  static constexpr cpp_register::Field<decltype(RCC->AHB2LPENR), (1UL << 4), cpp_register::AccessMode::RW, 1> CRYPLPEN{};
...
struct RCC_PLLI2SCFGR {
  static constexpr cpp_register::Field<decltype(RCC->PLLI2SCFGR), (1UL << 6), cpp_register::AccessMode::RW, 8U> PLLI2SN{};
  static constexpr cpp_register::Field<decltype(RCC->PLLI2SCFGR), (1UL << 28), cpp_register::AccessMode::RW, 3U> PLLI2SR0{};
};
