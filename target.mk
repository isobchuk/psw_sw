...
COMPONENTS 	:= meta_types cpp_register hal hal\stm32f2x7\reg hal\stm32f2x7\mcu embedded_printf_traces lcd flash
...
COMMONFLAGS	= -ggdb -mcpu=cortex-m3 -mthumb -mfloat-abi=soft $(OPTIMIZE) $(DEFINES) $(INCLUDES)
CFLAGS		=
CXXFLAGS 	= -std=c++20 -fdata-sections -ffunction-sections -fno-rtti -fno-exceptions -fno-threadsafe-statics -fconcepts-diagnostics-depth=5 -fno-builtin -ffreestanding -fno-builtin-memset
